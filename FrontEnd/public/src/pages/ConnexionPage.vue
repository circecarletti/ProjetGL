    ...
    methods: {
        ...
        onSubmit() {
            ...
            sendPost('https://orsaymediatheque.herokuapp.com/api/users/login', credentials).
                then( response => {
                    if(response.success){
                        console.log("Succesful connexion of user : ", {
                            email : response.user,
                            status : response.statut
                            });
                        this.$store.dispatch('setUserId', response.user);
                        ...
                        if(response.statut==="manager"){
                            ...
                            console.log("Error in connexion : Le statut renseigné n'est pas reconnu.");
                        }
