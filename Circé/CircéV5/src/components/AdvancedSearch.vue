<template>
    <div class="advanced-search-area">
        ...
        <div class="line">
            <div class="cell">
                <label for="advanced-search-year-id">Année de sortie : </label>
                <input type="number" id="advanced-search-year-id" v-model="year">
            </div>
        </div>
        <div class="line">
            <div class="cell">
        ...
        <div class="line bottom">
            ...
            <div class="cell bottom search" :class="{ disabled : searching }" @click="onClick">
...
/**
 * Props :
 *  searching : indique si une recherche est en cours, auquel cas on end inactif le bouton de recherche.
 * 
 * Events:
 *  search : Renvoie les critères demandés pour une recherche.
 *      L'object est de la forme (nb: tous les membre sont facultatifs):
 *      {
 *          title: String, titre ou partie du tire à rechercher
 *          author: String, nom ou partie du nom del'auteur
 *          year: Integer, année de création/édition
