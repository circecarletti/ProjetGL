...
export default {
    methods: {
        onRelease() {
            ...
            sendPost(`https://media-orsay-default-rtdb.firebaseio.com/releaseCustomer.json`, releasePayload).
                then( response => {
        ...
        deleteCustomer() {
            ...
            sendPost(`https://media-orsay-default-rtdb.firebaseio.com/deleteCustomer.json`, deletePayload).
                then( response => {
                    console.log(response);
