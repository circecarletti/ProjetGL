    ...
    <div class="add-resource-area">
        <form @submit.prevent="onSubmit">
            ...
            <div class="line">
                ...
                <div class="input-cell">
                    <input type="radio" id="add-resource-category-adultes"
                        v-model="category" value="adultes" name="category">
                    <label for="add-resource-category-adultes">Adultes</label>
                    <input type="radio" id="add-resource-category-enfants"
                        v-model="category" value="enfants" name="category">
                    <label for="add-resource-category-enfants">Enfants</label>
                    <input type="radio" id="add-resource-category-tous"
                        v-model="category" value="tous" name="category">
                    <label for="add-resource-category-tous">Tous</label>
                </div>
            </div>
...
export default {
    data() {
        return {
            ...
            yearRegEx: regexStringFormulaForAge
        }
    },
    watch: {
        title() {
    ...
    computed: {
        ...
        categoryNotValid() {
            return this.category !== 'adultes' && 
                    this.category !== 'enfants' && 
                    this.category !== 'tous';
        },
        authorNotValid() {
        ...
        yearNotValid() {
            return this.year.trim() === '' && !this.$refs['add-resource-year'].validity.valid;
        },
        resumeNotValid() {
        ...
        invalidData() {
            return this.titleNotValid || this.typeNotValid || this.fileNotValid ||
                    this.categoryNotValid || this.authorNotValid || this.yearNotValid ||
    ...
    methods: {
        onSubmit() {
            if (!this.invalidData) {
                ...
                sendFile('https://media-orsay-default-rtdb.firebaseio.com/newResource.json', formData). 
                    then( response => {
                        ...
                        return sendPost(
                            'https://media-orsay-default-rtdb.firebaseio.com/newResource.json', 
                            newResource);
                    }).
                    then( response => {
