...
export default {
    ...
    methods: {
        addBalance() {
            ...
            if (this.feedAmountDataNotValid) {
                ...
                sendPost('https://media-orsay-default-rtdb.firebaseio.com/updateBalance.json', updatePayload).
                    then( response => {
        ...
        addAccount() {
            ...
            if (this.createChildrenAccountDataNotValid) {
                ...
                sendPost('https://media-orsay-default-rtdb.firebaseio.com/addChildrenAccount.json', newAccountPayload).
                    then( response => {
                        console.log(response);
    ...
    mounted() {
        ...
        // de la promise
        this.waiting = true;
        sendGet('https://media-orsay-default-rtdb.firebaseio.com/users.json').
            then( response => {
